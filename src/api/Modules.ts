...
const Modules = {
    ...
    "DEG_P_N": new ModuleInfo(Authors.Intrigger, "DEG_P_N", pUrl + "131"),
    ...
    "MOD_PP_P": new ModuleInfo(Authors.Intrigger, "MOD_PP_P", pUrl + "251"),
    "GCF_PP_P": new ModuleInfo(Authors.KillReal, "GCF_PP_P", pUrl + "289"),
